...
REM
REM Generated by Vivado on Sun Sep 06 11:24:26 +0300 2026
...
echo "xvlog --incr --relax -prj Button_debounce_tb_vlog.prj"
call xvlog  --incr --relax -prj Button_debounce_tb_vlog.prj -log xvlog.log
