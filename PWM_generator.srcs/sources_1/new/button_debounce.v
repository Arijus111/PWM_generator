...
module button_debounce(
    ...
    output reg debounced_duty_pulse         //Synchronized and debounced duty cycle select button output;
        ...
        reg [1:0] frequency_synchronizer;           //Double flip-flop register for frequency button synchronization with clk;
        reg [1:0] duty_cycle_synchronizer;          //Double flip-flop register for duty-cycle button synchronization with clk;
